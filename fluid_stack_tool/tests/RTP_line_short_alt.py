...
def iterator(fluid, Boost_pump_dp):
    ...
    return circuit, circuit_RTP, pressure_report
...
def main():
    ...
    print(" ")
    print(" ")
    print("Tank Circuit Summary")
    print_circuit_summary(circuit)
    print("RTP Circuit Summary")
    print_circuit_summary(circuit_RTP)
    print_component_tally(
        build_combined_pressure_tally(
            [
                (circuit, pressure_report["circuit_1_inlet_pressure"]),
                (circuit_RTP, pressure_report["circuit_2_inlet_pressure"]),
            ]
        )
    )
